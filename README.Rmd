...
A docking layout manager provided by [dockViewR](https://github.com/cynkra/dockViewR) can be used as front-end to a [blockr](https://github.com/BristolMyersSquibb/blockr) board using this package.
