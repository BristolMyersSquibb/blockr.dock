...
`dock_layout(..., active = TRUE)` attaches an `active` attribute to the
layout. The validator rejects more than one layout marked `active`. If
none is marked, the first one wins.
