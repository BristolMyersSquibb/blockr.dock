...
new_dock_panel_id <- function(x, class = character()) {
  ...
  structure(x, c(class, "dock_panel_id"))
}
...
as_dock_panel_id <- function(x) {
  ...
  if (may_be_block_panel_id(x)) {
    new_dock_panel_id(x)
  } else if (may_be_ext_panel_id(x)) {
    new_ext_panel_id(x)
  } else {
    blockr_abort(
...
may_be_block_panel_id <- function(x) {
  grepl("^block_panel-", x)
}
...
#' @export
as_block_panel_id.dock_panel_id <- function(x) {
  blockr_abort(
...
may_be_ext_panel_id <- function(x) {
  grepl("^ext_panel-", x)
}
...
#' @export
as_ext_panel_id.dock_panel_id <- function(x) {
  blockr_abort(
